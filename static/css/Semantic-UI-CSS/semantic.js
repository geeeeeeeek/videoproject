...
$.fn.form.settings = {
  ...
  prompt: {
    empty                : '{name} 不能为空',
    checked              : '{name} 需要选中',
    email                : '{name} 必须为有效的邮件地址',
    url                  : '{name} 必须为合法的url',
    regExp               : '{name} 格式错误',
    integer              : '{name} 必须为整数',
    decimal              : '{name} must be a decimal number',
    number               : '{name} 必须为数字',
    is                   : '{name} 必须为 "{ruleValue}"',
    isExactly            : '{name} 必须为 "{ruleValue}"',
    not                  : '{name} 不能设置为 "{ruleValue}"',
    notExactly           : '{name} 不能设置为 "{ruleValue}"',
    contain              : '{name} 必须包含 "{ruleValue}"',
    containExactly       : '{name} 必须包含 "{ruleValue}"',
    doesntContain        : '{name} 不能包含  "{ruleValue}"',
    doesntContainExactly : '{name} 不能包含 "{ruleValue}"',
    minLength            : '{name} 至少 {ruleValue} 个字符',
    length               : '{name} 至少 {ruleValue} 个字符',
    exactLength          : '{name} 必须是 {ruleValue} 个字符',
    maxLength            : '{name} 不能多于 {ruleValue} 个字符',
    match                : '{name} must match {ruleValue} field',
    different            : '{name} must have a different value than {ruleValue} field',
    creditCard           : '{name} must be a valid credit card number',
    minCount             : '{name} 至少 {ruleValue} 个',
    exactCount           : '{name} 必须为 {ruleValue} 个',
    maxCount             : '{name} 最多 {ruleValue} 个'
  },
